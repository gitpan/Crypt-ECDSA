...
my $ecdsa =
  Crypt::ECDSA->new( standard => 'ECP-256', PEM => 't/test1ecdsa.pem' );
...
my $ecdsa_aes128 = Crypt::ECDSA->new(
    standard => 'ECP-256',
    PEM      => 't/test1aes128ec.pem',
    password => 'aes128ecaes128ec'
);
